...
public class MainVisitorFragmentPresenterTest extends MainBaseFragmentPresenterTest {
	
	@dagger.Module(
			injects = {
					MainVisitorFragmentPresenter.class,
					MainVisitorFragmentPresenterTest.class
			},
	...
	@Inject
	MainVisitorFragmentPresenter sut;
	...
	public void should_onOptionsItemSelected_performSwitchProfile() {
		MenuItem item = new TestMenuItem(org.laybe.proxymate.R.id.action_login);
